...
const AuthForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isSignIn) {
        const response = await axios.post('https://event-planner-ihsd.onrender.com/api/auth/login', formData);
        console.log('Login Successful:', response.data);
      } else {
        const response = await axios.post('https://event-planner-ihsd.onrender.com/api/auth/register', formData);
